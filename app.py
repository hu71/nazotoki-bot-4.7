...
「では早速、問題です！探偵見習いのテストです。制限時間は……所長が帰ってくるまでにしましょう。困ったら頭をひっくり返して、最初から考えてみるといいですよ。」''', "delay_seconds": 1}
        ],
...
「どうですか、探偵カエデの活躍を見て？ あなたもこんな風になれるよう頑張りましょう！謎も難しいですよ、探偵社のはチュートリアルみたいなものですからね！というわけで今日の一問！頭をひっくり返して解いてくださいね」''', "delay_seconds": 1}
        ],
...
いつも陽気なサクラにしては珍しく毒づくようなことを言う。''', "delay_seconds": 1},
            {"text": "「さて、 雑談もこの辺に、 次の問題です！難しいですよ、頭をぐるぐる回して考えてみてください」おもむろにサクラはいつもの調子を取り戻した。", "delay_seconds": 1}
        ],
