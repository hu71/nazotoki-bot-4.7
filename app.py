...
questions = [
    ...
    {
        "text": "第2問のストーリーと問題文",
        "image_url": "https://drive.google.com/uc?export=view&id=XXXXX2",  # 実際のGoogle Drive画像IDに置き換え
        "hint_keyword": "hint2",
        "hint_text": "第2問のヒントです"
    },
    {
        "text": "第3問のストーリーと問題文",
        "image_url": "https://drive.google.com/uc?export=view&id=XXXXX3",  # 実際のGoogle Drive画像IDに置き換え
        "hint_keyword": "hint3",
        "hint_text": "第3問のヒントです"
    },
    {
        "text": "第4問のストーリーと問題文",
        "image_url": "https://drive.google.com/uc?export=view&id=XXXXX4",  # 実際のGoogle Drive画像IDに置き換え
        "hint_keyword": "hint4",
        "hint_text": "第4問のヒントです"
    },
    {
        "text": "第5問のストーリーと問題文",
        "image_url": "https://drive.google.com/uc?export=view&id=XXXXX5",  # 実際のGoogle Drive画像IDに置き換え
        "hint_keyword": "hint5",
        "hint_text": "第5問のヒントです"
    },
    {
        "text": "終章: 最後の問題",
        "image_url": "https://drive.google.com/uc?export=view&id=XXXXX6",  # 実際のGoogle Drive画像IDに置き換え
        "hint_keyword": "hint6",
        "hint_text": "最後のヒントです"
    }
]
